...
exports.chalk = exports.MODULE_NAME = void 0;
const chalk_1 = __webpack_require__(/*! chalk */ "./node_modules/chalk/source/index.js");
exports.MODULE_NAME = '[KoboldCpp-Switcher]';
...
const kobold_1 = __webpack_require__(/*! ./kobold */ "./src/kobold.ts");
class Handlers {
    constructor(controller) {
        this.getRunningModel = (_, res) => __awaiter(this, void 0, void 0, function* () {
            let status = 200;
            const data = { model: undefined, error: undefined };
            yield (0, kobold_1.getLoadedModelName)()
                .then(name => data.model = name)
                .catch(err => {
                data.error = 'error requesting koboldcpp running model';
                status = 500;
                console.error(chalk_1.default.redBright(consts_1.MODULE_NAME), 'KoboldCpp unavailable');
                console.error(err);
            });
        ...
        this.deleteModel = (_, res) => __awaiter(this, void 0, void 0, function* () {
            yield this
                .controller
                .stopKoboldCpp()
                .catch( /* well, no luck */);
...
const consts_1 = __webpack_require__(/*! ./consts */ "./src/consts.ts");
const endpoints_1 = __webpack_require__(/*! ./endpoints */ "./src/endpoints.ts");
const kobold_1 = __webpack_require__(/*! ./kobold */ "./src/kobold.ts");
class KoboldRunnerPlugin {
    constructor() {
        ...
        this.controller = new kobold_1.Controller();
        this.handlers = new endpoints_1.Handlers(this.controller);
        /**
        * Initialize the plugin.
        * @param router Express Router
        */
        this.init = (router) => __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(consts_1.chalk.green(consts_1.MODULE_NAME), 'Plugin loaded!');
        });
        this.exit = () => __awaiter(this, void 0, void 0, function* () {
            yield this.controller.stopKoboldCpp();
            console.log(consts_1.chalk.yellow(consts_1.MODULE_NAME), 'Plugin exited');
        });
    }
}
...
class Controller {
    ...
    runKoboldCpp(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let stdOutLine = '';
            (_b = this.processIO.stdout) === null || _b === void 0 ? void 0 : _b.on('data', function (data) {
                stdOutLine += data;
            ...
            let stdErrLine = '';
            (_d = this.processIO.stderr) === null || _d === void 0 ? void 0 : _d.on('data', function (data) {
                stdErrLine += data;
                if (stdErrLine.indexOf('\n') === -1) {
                    return;
                }
                stdErrLine.
                    split('\n').
                    map((line) => console.error(consts_1.chalk.redBright(consts_1.MODULE_NAME), '[KoboldCpp]', line));
                stdErrLine = '';
            });
            while (1) { // wait for model to be available
                try {
                    yield getLoadedModelName();
                }
                catch (_e) {
                    continue;
                }
...
function getLoadedModelName() {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield fetch(koboldAPIEndpoint + '/model', { method: 'GET' });
        const data = yield resp.json();
        // e.g. koboldcpp/nvidia_Llama-3_3-Nemotron-Super-49B-v1-Q4_K_S
        return data.result.split('/', 2)[1];
    });
}
exports.getLoadedModelName = getLoadedModelName;
